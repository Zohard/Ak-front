  ...
  <div :class="['flex items-start gap-3', disabled && 'opacity-60 cursor-not-allowed']">
    <div class="relative flex items-center">
      <input
        :id="computedId"
        type="radio"
        class="h-5 w-5 border-border text-primary-600 focus:ring-primary-500/20 focus:ring-2 focus:outline-none"
...
const computedId = computed(() => props.id || `radio-${props.name || props.group || uid}-${uid}`)
